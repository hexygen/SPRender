% RenderMeshFeaturePoints:
% Render a triangular mesh with feature points.
%
% Input:
...
% http://www.yanirk.com
function [ fig, S ] = RenderMeshFeaturePoints( shape, features, rotation, savename, fig )
...
[fig, S] = RenderShapeBase(shape, [], [], features, 0, 0, 0, 0, rotation, savename, fig);
