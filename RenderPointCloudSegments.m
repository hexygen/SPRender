% RenderPointCloudSegments:
% Renders a segmented point cloud. Segments are marked by a different
% vertex color.
%
% Input:
...
% http://www.yanirk.com
function [ fig, S ] = RenderPointCloudSegments( shape, segs, rotation, savename, fig  )
...
[fig, S] = RenderShapeBase(shape, segs, [], [], 1, 1, 0, 0, rotation, savename, fig);
